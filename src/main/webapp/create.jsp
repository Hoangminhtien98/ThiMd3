...
<div class="col-lg-9 col-md-8">
    ...
    <div class="card">
        ...
        <div class="card-body row">
            <form action="${pageContext.request.contextPath}/product?action=createPost" method="post">
                <table border="1" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <button type="button" class="btn btn-outline-dark"><a href="${pageContext.request.contextPath}/product">Back</a></button>
                        </td>
                    </tr>
                    <tr>
